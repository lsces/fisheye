<div class="floaticon">
	...
	{if $gContent->hasUpdatePermission()}
		<a title="{tr}Load Seasons{/tr}" href="{$smarty.const.FISHEYE_PKG_URL}load_program.php?gallery_id={$gContent->mGalleryId}">{biticon ipackage="icons" iname="folder-open" iexplain="Load Seasons"}</a>
