<div class="floaticon">
	...
	{if $gContent->hasUpdatePermission()}
		{if $gContent->getTitle() eq 'Music'}
			...
			<a title="{tr}Add Music Collection{/tr}" href="{$smarty.const.FISHEYE_PKG_URL}load_music.php">{biticon ipackage="icons" iname="folder-new" iexplain="Add Music Collection"}</a>
		{else}
